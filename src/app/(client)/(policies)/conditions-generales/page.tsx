            ...
            <section>
                ...
                <div className={styles.container}>
                    <article>
                        ...
                        <p>Numéro de téléphone : 07.72.18.21.25</p>
                        <p>Adresse e-mail : florianmignot25@gmail.com.</p>
                        <p>L&apos;hébergeur du site florianmignot.fr est la société OVH, dont le siège social est situé au 2 rue Kellermann 59053 Roubaix. </p>
                    </article>
                    <article>
                        <h2>ARTICLE 2 : Accès au site</h2>
                        <p>Le site florianmignot.fr permet à l&apos;Utilisateur un accès gratuit aux services suivants :</p>
                        <p>Le site internet propose les services suivants :</p>
                        <p>Informer sur les prestations commerciale dispensées par Florian MIGNOT, ainsi qu&apos;un service de prise de
                            contact </p>
                    ...
                    <article>
                        ...
                        <p>Le site assure à l&apos;Utilisateur une collecte et un traitement d&apos;informations personnelles dans le respect
                            ...
                            et aux libertés ainsi qu&apos;à la réglementation RGPD.</p>
                        <p>En vertu de la loi Informatique et Libertés, en date du 6 janvier 1978, l&apos;Utilisateur dispose d&apos;un droit
                            ...
                            exerce ce droit :</p>
                        <p>par mail à l&apos;adresse mail florianmignot25@gmail.com</p>
                        <p>Pour plus d&apos;information veuillez vous référer à notre <a target="_blank" href="/politique-de-confidentialite">Politique de Confidentialité</a></p>
                    </article>
                    <article>
                        ...
                        <p> L&apos;Utilisateur doit solliciter l&apos;autorisation préalable du site pour toute
                            reproduction, publication, copie des différents contenus. Il s&apos;engage à une utilisation des contenus du
                            site dans un cadre strictement privé, toute utilisation à des fins commerciales et publicitaires est
                        ...
                        <p>Toute représentation totale ou partielle de ce site par quelque procédé que ce soit, sans l&apos;autorisation
                            ...
                            335-2 et suivants du Code de la propriété intellectuelle.</p>
                    ...
                    <article>
                        ...
                        <p>Les sources des informations diffusées sur le site florianmignot.fr sont réputées fiables mais le site
                            ne garantit pas qu&apos;il soit exempt de défauts, d&apos;erreurs ou d&apos;omissions.</p>
                        <p>Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle.
                            Malgré des mises à jour régulières, le site florianmignot.fr ne peut être tenu responsable de la
                            ...
                            dans ce site.</p>
                        <p>Le site florianmignot.fr ne peut être tenu pour responsable d&apos;éventuels virus
                            qui pourraient infecter l&apos;ordinateur ou tout matériel informatique de l&apos;Internaute, suite à une
                            utilisation, à l&apos;accès, ou au téléchargement provenant de ce site.</p>
                    ...
                    <article>
                        ...
                        <p>Des liens hypertextes peuvent être présents sur le site. L&apos;Utilisateur est informé qu&apos;en cliquant sur ces
                            liens, il sortira du site florianmignot.fr. Ce dernier n&apos;a pas de contrôle sur les pages web sur
                    ...
                    <article>
                        ...
                        <p>Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l&apos;ordinateur de
                            l&apos;Utilisateur par votre navigateur et qui sont nécessaires à l&apos;utilisation du site florianmignot.fr.
                            ...
                            cookies expirent à la fin de la visite de l&apos;Utilisateur, d&apos;autres restent.</p>
                        <p>L&apos;information contenue dans les cookies est utilisée pour améliorer le site florianmignot.fr.</p>
                        <p>En naviguant sur le site, L&apos;Utilisateur les accepte.</p>
                        <p>L&apos;Utilisateur doit toutefois donner son consentement quant à l&apos;utilisation de
                            certains cookies.</p>
                        <p>A défaut d&apos;acceptation, l&apos;Utilisateur est informé que certaines fonctionnalités ou pages risquent de lui
                            être refusées.</p>
                        <p>L&apos;Utilisateur pourra désactiver ces cookies par l&apos;intermédiaire des paramètres
